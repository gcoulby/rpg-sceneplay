...
const IndexCards: React.FC<IndexCardsProps> = ({ editor, scrollContainer }) => {
  ...
  const canRedo =
    dragMode && historyRef.current.pointer < historyRef.current.stack.length - 1
      ...
      const scrollLoop = () => {
        ...
        if (container && scrollSpeedRef.current !== 0) {
          ...
          if (lastClientPosRef.current) {
            const gap = calcInsertIndexRef.current(
  ...
  return (
    <div className={containerClass} ref={containerRef}>
          ...
          >
            {fullscreen ? (
              ...
              >
                ...
                <line x1="8" y1="6" x2="13" y2="1" />
                <polyline points="5,13 1,13 1,9" />
                <line x1="6" y1="8" x2="1" y2="13" />
              </svg>
            )}
          </button>
          <button
      ...
      <div
        className="gap-3 grid index-cards-grid grid-cols-3 max-[1200px]:grid-cols-2 max-[800px]:grid-cols-1 p-3 px-4"
        ref={gridRef}
        ...
        {displayScenes.length === 0 ? (
          ...
          <>
            {displayScenes.map((scene, index) => {
              ...
              const movedUp =
                dragMode && origNum !== undefined && newNum < origNum
              const movedDown =
                dragMode && origNum !== undefined && newNum > origNum
              ...
              return (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: scene.color || 'var(--fd-text-muted)',
                    }}
                  />
                  <div className="flex flex-col flex-1 gap-2 px-3 py-2.5 min-w-0">
                    <div className="flex items-start gap-2">
                      ...
                      <div
                        ...
                        title={
                          dragMode ? undefined : 'Click to navigate to scene'
                        }
                      >
                        {scene.heading}
                      </div>
                        ...
                        <div className="flex gap-1 text-[9px] text-(--fd-text-muted) [font-variant-numeric:tabular-nums] shrink-0 ml-auto items-center whitespace-nowrap">
                          {sceneLengths[index] > 0 && (
                            <span className="font-semibold">
                              {Number(sceneLengths[index].toFixed(1))}p
                            </span>
                          )}
                          {sceneTimings[index]?.finalSeconds > 0 && (
                            <span
                              ...
                              style={{
                                color: getTimingColor(
                                  sceneTimings[index].finalSeconds,
                                ),
                              }}
                            >
                              {formatSceneDuration(
      ...
      {dragIdx !== null && dragPos && dragCardHtml && (
        <div
          className="z-[10000] fixed opacity-[0.92] shadow-[0_8px_24px_rgba(0,0,0,0.4)] overflow-hidden [pointer-events:none!important] [&_*]:[pointer-events:none!important]"
          style={{
