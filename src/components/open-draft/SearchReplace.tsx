...
const SearchReplace: React.FC<SearchReplaceProps> = ({ editor }) => {
  ...
  return (
    ...
    >
      ...
      <div className="p-3 search-replace-body">
        <div className="flex items-center gap-2 mb-2 search-row">
          <label className="min-w-[55px] text-xs text-(--fd-text-muted)">
            Find:
          </label>
          <input
            ref={inputRef}
        ...
        <div className="flex gap-4 mb-2.5 search-options">
        ...
        <div className="flex gap-1.5 search-actions">
          <button
