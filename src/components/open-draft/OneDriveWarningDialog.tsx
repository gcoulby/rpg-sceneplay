...
const OneDriveWarningDialog: React.FC = () => {
  ...
  return (
    <div className="dialog-overlay" onClick={dismiss}>
      <div
        className="max-w-[520px] dialog-box"
      ...
      >
        ...
        <div className="dialog-body">
          ...
          <pre className="bg-[#f4f4f4] mb-3 px-2.5 py-2 border border-[#ddd] rounded text-[#1a1a1a] text-xs break-words whitespace-pre-wrap">
            {path}
          </pre>
          ...
          <ol className="m-0 mb-0 ml-[18px] pl-0 text-[13px] leading-[1.6]">
            ...
            <li>
              ...
              (typically Documents or Desktop), or exclude OpenDraft's app data
              folder explicitly.
            </li>
            <li>Restart OpenDraft.</li>
          </ol>
        </div>
        <div className="flex gap-2 dialog-footer">
