...
const WritingSuggestionsModal: React.FC<WritingSuggestionsModalProps> = ({
  editor,
  onClose,
}) => {
    ...
    >
      ...
      <div className="spell-modal-body">
        ...
        <div className="spell-modal-section">
          ...
          <div
            style={{ fontSize: 13, color: 'var(--fd-text)', lineHeight: 1.4 }}
          >
        ...
        <div className="spell-modal-section">
          ...
          <div className="spell-modal-suggestions">
            ...
            currentIssue.suggestions.length === 0 ? (
              <div className="spell-modal-no-suggestions">
